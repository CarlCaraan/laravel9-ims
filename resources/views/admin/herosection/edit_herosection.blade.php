...
@section('title') Edit Herosection | Division of Laguna @endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3 class="text-success">Edit Herosection</h3>
                <p class="text-subtitle text-muted">Edit Announcement.</p>
            </div>
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('user.herosection.update', $editData->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 text-left">
                                <img class="mb-3 img-fluid" id="show_image" src="{{ (!empty($editData->image)) ? url('upload/user_siteinfo/herosection/'.$editData->image) : url('upload/user_siteinfo/herosection/default_photo.png') }}" alt="image">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="border-top mt-4">
                            <div class="card-body">
                                <button type="submit" class="btn btn-success">Update Herosection</button>
                            </div>
                        </div>
                    </form>
                </div>
